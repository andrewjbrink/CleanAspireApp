...
resource script_sql_CleanArchitecture 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'CleanArchitecture', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
