...
param migrations_containerport string
...
resource mainContainer 'Microsoft.Web/sites/sitecontainers@2025-03-01' = {
  ...
  properties: {
    ...
    isMain: true
    targetPort: migrations_containerport
...
resource webapp 'Microsoft.Web/sites@2025-03-01' = {
  name: take('${toLower('migrations')}-${uniqueString(resourceGroup().id)}', 60)
  location: location
  properties: {
    serverFarmId: plan_outputs_planid
    keyVaultReferenceIdentity: migrations_identity_outputs_id
    siteConfig: {
      numberOfWorkers: 1
      ...
      appSettings: [
        {
          name: 'WEBSITES_PORT'
          value: migrations_containerport
        }
        {
...
resource migrations_website_ra 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
