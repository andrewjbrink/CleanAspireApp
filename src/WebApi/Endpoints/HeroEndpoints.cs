using MediatR;
using CleanAspireApp.Application.UseCases.Heroes.Commands.CreateHero;
using CleanAspireApp.Application.UseCases.Heroes.Commands.UpdateHero;
using CleanAspireApp.Application.UseCases.Heroes.Queries.GetAllHeroes;
